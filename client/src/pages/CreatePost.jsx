    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
          Create visually stunning images generated by DALL-E AI and share them with the community
        </p>
      </div>
      <form onSubmit={handleSubmit} className='mt-16 max-w-3xl'>
        ...
        <div className='mt-6'>
          ...
          <button
            type='submit'
            className='mt-4 bg-[#6469ff] text-white font-medium rounded-md text-sm
